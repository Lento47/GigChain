...
/**
 * @title ChainLinkProProfile
 * @notice NFT representing professional profiles on ChainLinkPro
 ...
 */
contract ChainLinkProProfile is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("ChainLinkPro Profile", "CLPP") Ownable(msg.sender) {}
